...
class AudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post audios_url, params: { audio: { audio: @audio.audio, created_at: @audio.created_at, title: @audio.title, updated_at: @audio.updated_at } }
    end
  ...
  test "should update audio" do
    patch audio_url(@audio), params: { audio: { audio: @audio.audio, created_at: @audio.created_at, title: @audio.title, updated_at: @audio.updated_at } }
