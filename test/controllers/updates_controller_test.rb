...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { author: @update.author, body: @update.body, title: @update.title } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { author: @update.author, body: @update.body, title: @update.title } }
