...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { bitcoin_wallet_address: @donation.bitcoin_wallet_address, body: @donation.body, title: @donation.title } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { bitcoin_wallet_address: @donation.bitcoin_wallet_address, body: @donation.body, title: @donation.title } }
